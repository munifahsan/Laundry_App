package com.tiunida.laundry0.ActivityOrder.biasa.ui;
...
import com.tiunida.laundry0.ActivityOrder.biasa.BiasaPresenter;
import com.tiunida.laundry0.ActivityOrder.biasa.BiasaPresenterMvp;
...
//    TextView mWaktuPesananValue;
    ...
    @BindView(R.id.biasaToolbar)
    Toolbar mBiasaToolbar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(mBiasaToolbar);
        ...
        mBiasaToolbar.setNavigationIcon(R.drawable.ic_backspace_black);
        mBiasaToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
