...
public class ExpressActivity extends AppCompatActivity implements ExpressViewMvp{
    ...
    private ExpressPresenterMvp mExpressPresenterMvp;
...
//    TextView mWaktuPesananValue;
    ...
    @BindView(R.id.expressToolbar)
    Toolbar mExpressToolbar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_express);

        mExpressPresenterMvp = new ExpressPresenter(this);
        mExpressPresenterMvp.onCreate();
        ...
        setSupportActionBar(mExpressToolbar);
        ...
        getSupportActionBar().setTitle("ORDER EXPRESS");
        mExpressToolbar.setNavigationIcon(R.drawable.ic_backspace_black);
        mExpressToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
...
//        mWaktuPesananValue.setText(mNowTime);
    ...
    public void navigateToMainScreen() {
        Intent mainIntent = new Intent(ExpressActivity.this, MainActivity.class);
