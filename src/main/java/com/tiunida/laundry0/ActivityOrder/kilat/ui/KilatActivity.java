package com.tiunida.laundry0.ActivityOrder.kilat.ui;
...
import com.tiunida.laundry0.ActivityOrder.kilat.KilatPresenter;
import com.tiunida.laundry0.ActivityOrder.kilat.KilatPresenterMvp;
...
public class KilatActivity extends AppCompatActivity implements KilatViewMvp {
    ...
    private KilatPresenterMvp mKilatPresenterMvp;

    @BindView(R.id.kilatToolbar)
    Toolbar mKilatToolbar;
...
//    TextView mWaktuPesananValue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kilat);

        mKilatPresenterMvp = new KilatPresenter(this);
        mKilatPresenterMvp.onCreate();
        ...
        setSupportActionBar(mKilatToolbar);
        ...
        getSupportActionBar().setTitle("ORDER KILAT");
        mKilatToolbar.setNavigationIcon(R.drawable.ic_backspace_black);
        mKilatToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void navigateToMainScreen() {
        Intent mainIntent = new Intent(KilatActivity.this, MainActivity.class);
    ...
    public void getDoneTime() {
        ...
        dateFormat = new SimpleDateFormat("EEEEEE, d MMM, yyyy");
    ...
    public void confirmOnClick() {
        ...
        mKilatPresenterMvp.validateInputs(desc, timeNow, uniqNumTime, timeDone,
    ...
    public void bandanaMinOnclick() {
        ...
        if (mBandanaInt < 1)
            mBandanaInt = 0;
        mBandanaNum.setText(String.valueOf(mBandanaInt));
    }
