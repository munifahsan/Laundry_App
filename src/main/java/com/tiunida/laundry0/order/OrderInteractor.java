...
public class OrderInteractor implements OrderInteractorMvp {
    private OrderRepositoryMvp mOrderRepositoryMvp;
    public OrderInteractor(){
        mOrderRepositoryMvp = new OrderRepository();
    }

    @Override
    public void doInputs(String desc, String time,
