...
import com.tiunida.laundry0.editProfile.ui.EditProfileViewMvp;
...
public class EditProfilePresenter implements EditProfilePresenterMvp{
    ...
    public void onEventMainThread(EditProfileEvent event){
        switch (event.getEventType()){
            ...
            case EditProfileEvent.onGetDataSuccess:
                onGetDataSuccess(event.getDataName(),event.getDataNim(),event.getDataDormitory(),event.getDataRoom(),event.getDataPhone(),event.getDataStatus(),event.getDataGender());
                break;
    ...
    public void onGetDataSuccess(String dataName, String dataNim, String dataDormitory, String dataRoom, String dataPhone, String dataStatus, String dataGender){
        if (mEditProfileViewMvp != null){
            ...
            mEditProfileViewMvp.setData(dataName,dataNim,dataDormitory,dataRoom,dataPhone,dataStatus,dataGender);
    ...
    public void validateInput(String name, String nim, String dormitory, String room, String phone, String gender, String status){
        if (!validateName(name) | !validateNim(nim) | !validateDormitory(dormitory) | !validateRoom(room) | !validatePhoneNumber(phone)) {
            return;
        }
        ...
        //}
        // }
        mEditProfileInteractorMvp.doStoreFirestore(name, nim, dormitory, room, phone, gender, status);
    }
